...
namespace Camera2.HarmonyPatches
{
    ...
    static class TransparentWalls
    {
        ...
        private static void Postfix(Transform ____obstacleCore, ParametricBoxFakeGlowController ____obstacleFakeGlow, MaterialPropertyBlockController[] ____materialPropertyBlockControllers)
        {
